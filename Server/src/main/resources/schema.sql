CREATE DATABASE IF NOT EXISTS `pointServiceWuGongV3` default charset utf8 COLLATE utf8_general_ci;
use pointServiceWuGongV3;
...
CREATE TABLE IF NOT EXISTS `ZuZhiPingJia` (
  ...
  `lastTotal` int(11) DEFAULT 100,
  `lastGivenValue` int(11),
  `thisTotal` int(11),
  `thisGivenValue` int(11),
  `plusItem` int(11),
  `minusItem` int(11),
  `totalPlus` int(11),
  `lastModifiedTime` timestamp,
